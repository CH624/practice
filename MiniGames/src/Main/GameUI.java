...
public class GameUI extends JFrame implements ActionListener{
    ...
    public void setUI() {
        ...
        title.setPreferredSize(new Dimension(850, 162));
        main.setLayout(new GridLayout(2,3,8,0));
        for(int i=0; i<6; i++) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == btnStart) {
			...
			if(game1==false && game2==false && game3==false && game4==false && game5==false && game6==false)
				game1= true;
			else game1= false;
			onOff();
		}else if(obj == btns[1]){
